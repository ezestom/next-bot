export const keywordResponses = [
	...
	},
	{
		...
		response:
			"Con Cacta puedes monitorear tu impacto ambiental en tiempo real y recibir alertas configurables para actuar rápidamente.",
	},
	{
		keywords: [
		...
		response:
			"Cacta permite el monitoreo por establecimiento, asegurando un control completo de las operaciones, recursos y rendimientos en cada campo.",
	},
	{
		keywords: [
		...
		response:
			"Cacta proporciona trazabilidad del uso de recursos y las emisiones generadas por tus actividades, ayudando a mejorar la eficiencia y la sustentabilidad.",
	},
	{
		keywords: [
		...
		response:
			"Cacta incluye Declaraciones Ambientales de Producto, mostrando el impacto ambiental a lo largo de todo el ciclo de vida del material.",
	},
	{
		keywords: [
			"Cálculo medioambiental",
			"cálculo de huella ambiental",
			"cálculo de impacto ambiental",
		],
		response:
			"Cacta centraliza toda tu información en una sola pantalla, permitiendo identificar de forma sencilla los principales contribuyentes de tu huella ambiental.",
	},
	{
		keywords: [
			"Cadena de valor",
		...
		response:
			"Cacta desagrega los indicadores de impacto para cada actor de tu cadena de valor, facilitando el reporte según los estándares internacionales.",
	},
	{
		keywords: [
			"Reportes EPD",
	...
	},
	{
		...
		response:
			"Nuestro principal objetivo es que las empresas tomen decisiones informadas, reduciendo su impacto ambiental y optimizando su eficiencia operativa.",
	},
	{
		keywords: [
		...
		response:
			"Cacta se conecta a tu sistema de gestión, obteniendo información confiable y con trazabilidad.",
	},
	{
		keywords: [
			"Desarrollo agrícola",
		...
		response:
			"Cacta es software desarrollado por y para agricultores bajo la metodología de Análisis de Ciclo de Vida (LCA).",
	},
	{
		keywords: [
			"Gestión sustentable",
			"gestión ambiental",
			"automación de gestión",
		],
		response:
			"Cacta ofrece paneles e informes automatizados que harán de tu gestión sustentable una labor simple y eficaz.",
	},
	{
		keywords: [
	...
	},
	{
		...
		response:
			"Cacta promueve la sustentabilidad en la agricultura, ayudando a los productores a reducir su impacto ambiental mientras optimizan sus operaciones.",
	},
];
